<nav class="p-4 fixed h-full w-80 flex flex-col justify-start">
    <h1 class="font-bold text-center my-4 text-2xl text-[#4f4f4f]"><span class="text-[#0BA5EC]">E</span>-Learning</h1>
    <ul class="list-none flex flex-col gap-4">
        <li>
            <a href="profile" class="nav-link">
                <i class="fa-xl fa-solid fa-user"></i>
                <p>Profile</p>
            </a>
        </li>
        <li>
            <a href="dashboard" class="nav-link">
                <i class="fa-xl fa-solid fa-house"></i>
                <p>Dashboard</p>
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="task" class="nav-link">
                <i class="fa-xl fa-solid fa-list-check"></i>
                <p>Task</p>
            </a>
        </li>
        <li>
            <a href="exam" class="nav-link">
                <i class="fa-xl fa-solid fa-chalkboard"></i>
                <p>Exam</p>
            </a>
        </li>
        <!-- <li>
    ...
    <div class="footer mt-auto mb-32 flex flex-col  gap-6">
        <div class="settings">
            <a href="#" class="flex justify-start gap-2 w-full font-medium text-gray-700 align-middle ">
                <i class="fa fa-cog text-gray-500 fa-lg" aria-hidden="true"></i>
                <p class="text-base self-center">Settings</p>
            </a>
        </div>
        <div class="profile flex justify-between pt-4 border-t h-16 border-[#EAECF0]">
