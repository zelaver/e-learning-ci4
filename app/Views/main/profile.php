            ...
            <div class="relative bg-white rounded-lg shadow ">
                ...
                <form class="my-4 flex flex-col gap-4" method="POST" action="login">
                    <div class="relative mx-4">
                        ...
                        <label for="email" class="label-email absolute top-1/2 -translate-y-1/2 ml-12 transition-all text-gray-400 bg-white px-2 duration-100 peer-invalid:text-red-500">Nama</label>
                    ...
                    <div class="relative mx-4">
                        <input class=" input-password block w-full outline-none h-16 rounded-lg pl-14 border-gray-300 border relative peer invalid:border-red-500 invalid:text-red-500" id="password" placeholder="" name="password">
                        <label for="password" class="label-password absolute top-1/2 -translate-y-1/2 ml-12 transition-all text-gray-400 bg-white px-2 duration-100 peer-invalid:text-red-500">Kelas</label>
                    ...
                    <div class="relative mx-4">
                        <input class=" input-password block w-full outline-none h-16 rounded-lg pl-14 border-gray-300 border relative peer invalid:border-red-500 invalid:text-red-500"  id="password" placeholder="" name="password">
                        <label for="password" class="label-password absolute top-1/2 -translate-y-1/2 ml-12 transition-all text-gray-400 bg-white px-2 duration-100 peer-invalid:text-red-500">Parent</label>
                        <label class="absolute  top-1/2 -translate-y-1/2 flex items-center p-4 gap-2 text-sm" for="password">
                    ...
                    <div class="relative mx-4">
                        <input class=" input-password block w-full outline-none h-16 rounded-lg pl-14 border-gray-300 border relative peer invalid:border-red-500 invalid:text-red-500"  id="password" placeholder="" name="password">
                        <label for="password" class="label-password absolute top-1/2 -translate-y-1/2 ml-12 transition-all text-gray-400 bg-white px-2 duration-100 peer-invalid:text-red-500">Address</label>
                        <label class="absolute  top-1/2 -translate-y-1/2 flex items-center p-4 gap-2 text-sm" for="password">
                    ...
                    <div class="relative mx-4">
                        <input class=" input-password block w-full outline-none h-16 rounded-lg pl-14 border-gray-300 border relative peer invalid:border-red-500 invalid:text-red-500"  id="password" placeholder="" name="password">
                        <label for="password" class="label-password absolute top-1/2 -translate-y-1/2 ml-12 transition-all text-gray-400 bg-white px-2 duration-100 peer-invalid:text-red-500">Phone</label>
                        <label class="absolute  top-1/2 -translate-y-1/2 flex items-center p-4 gap-2 text-sm" for="password">
                    ...
                    <div class="relative mx-4">
                        <input class=" input-password block w-full outline-none h-16 rounded-lg pl-14 border-gray-300 border relative peer invalid:border-red-500 invalid:text-red-500"  id="password" placeholder="" name="password">
                        <label for="password" class="label-password absolute top-1/2 -translate-y-1/2 ml-12 transition-all text-gray-400 bg-white px-2 duration-100 peer-invalid:text-red-500">Email</label>
                        <label class="absolute  top-1/2 -translate-y-1/2 flex items-center p-4 gap-2 text-sm" for="password">
            ...
            <div class="profile-content mx-10 pt-20 flex flex-col gap-8 z-50 bg-white">
                ...
                <div class="profile-contact flex gap-20">
                    <div class="parents grid gap-y-4 gap-x-4">
                        ...
                        <p class="text-base flex justify-center items-center font-bold"><?php echo session()->get('nama') ?></p>
                    </div>
